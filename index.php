        ...
        <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
            ...
            <div class="form-row justify-content-center align-items-center">
              <div class="col-12 col-md-3">
                <button type="button" class="btn btn-primary btn-block btn-lg" style="text-align: center;" data-toggle="modal" data-target="#registerModal">Anmelden
                </button>
              </div>
                    ...
                    <div class="modal-body">
                      ...
                      <form action="" method="post">
                        ...
                        <div class="modal-footer">
                          ...
                          <button type="button" class="btn btn-primary" type="submit">Registrieren</button>
                        </div>
                      </form>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <form action="" method="post">
                        <!-- benutzername -->
                        <div class="form-group">
                          <input type="text" name="username" class="form-control" id="username" value="<?php echo $username ?>" placeholder="Benutzername" title="Benutzername" maxlength="30" required="true">
                        </div>
                        <!-- password -->
                        <div class="form-group">
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="button" class="btn btn-primary" type="submit">Anmelden</button>
                    </div>
                  </div>
                </div>
              </div>
